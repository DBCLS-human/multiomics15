...
class AlleleStanza < TogoStanza::Stanza::Base
  property :search do |sample, chromosome, position|
    "Sample=#{sample}, Chromosome=#{chromosome}, Position=#{position}"
  end

  property :alleles do |sample, chromosome, position|
